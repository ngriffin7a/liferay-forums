...
@Generated("")
@GraphQLName(
	description = "A user subscribed to a forum resource.", value = "Subscriber"
)
...
public class Subscriber implements Serializable {
	...
	public static Subscriber toDTO(String json) {
		return ObjectMapperUtil.readValue(Subscriber.class, json);
	}

	public static Subscriber unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Subscriber.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.forum.subscriptions.dto.v1_0.Subscriber",
		name = "x-class-name"
	)
